...
const conectaBancoDeDados = require('./bancoDeDados') //aqui estou ligando o arquivo bancoDeDados
...
app.use(router.post('/mulheres', criaMulher))//configurei rota POST criaMulher
app.use(router.patch('/mulheres/:id', corrigiMulher))//configurei a rota PATCH /mulher/:id
